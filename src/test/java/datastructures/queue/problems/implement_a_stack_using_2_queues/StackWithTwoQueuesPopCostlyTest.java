...
class StackWithTwoQueuesPopCostlyTest {

    private StackWithTwoQueuesPopCostly<Integer> stackWithTwoQueues;

    @BeforeEach
    public void init() {
        stackWithTwoQueues = new StackWithTwoQueuesPopCostly<>(5);
    }
